...
class TestExecute(object):
    ...
    def test_it_only_returns_top_level_annotations(self,
        ...
        search.append_qualifier.assert_any_call(TopLevelAnnotationsFilter.return_value)
    ...
    def test_it_only_shows_annotations_from_current_authority(self,
        ...
        search.append_qualifier.assert_any_call(AuthorityFilter.return_value)
    ...
    def search(self, annotations):
        search = mock.Mock(
            spec_set=['append_qualifier', 'append_aggregation', 'run'])
